...
GO
CREATE PROCEDURE [dbo].[ame_UnPackApartAllRecord]
...
AS
	...
	delete from tmpUR
	insert into UnPackingParts select PONumber,Model,Serial from PackingRecord where BoxNumber=@BoxUnPackApart 
	return
GO